...
import TextImageBlock from "@/components/project/custom-body/TextImageBlock";
  ...
  return (
    <div>
      <Section title={'Interactivity'}>
        <TextImageBlock img="/projects/sudoku/assets/completion-animation.gif" alt="completion-animation">
          {[
      ...
      <Section title="Board generator">
        ...
        <TextImageBlock reverse img="/projects/sudoku/assets/algo-hori.jpg">
          {[
        ...
        <TextImageBlock img="/projects/sudoku/assets/algo-vert.jpg">
          {[
